...
namespace Libraary.Data.Migrations
{
    ...
    [Migration("20190726104224_AddedTableForRatings")]
    partial class AddedTableForRatings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Libraary.Domain.AuthorBooks", b =>
                {
            ...
            modelBuilder.Entity("Libraary.Domain.Rating", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("CountOfScoresOne");

                    b.Property<int>("CountOfScoresThree");

                    b.Property<int>("CountOfScoresTwo");
            ...
            modelBuilder.Entity("Libraary.Domain.Rating", b =>
                {
                    b.HasOne("Libraary.Domain.Book", "Book")
                        .WithOne("Rating")
                        .HasForeignKey("Libraary.Domain.Rating", "BookId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
